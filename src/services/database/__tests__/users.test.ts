...
describe('Users Database Service', () => {
    ...
    describe('fetchUserProfile', () => {
        ...
        it('should throw DatabaseError when fetch fails', async () => {
            ...
            await expect(fetchUserProfile(mockUserId)).rejects.toThrow('Failed to fetch user profile');
        });
    });
    ...
    describe('isUsernameUnique', () => {
        ...
        it('should throw DatabaseError when check fails', async () => {
            ...
            await expect(isUsernameUnique(mockUsername)).rejects.toThrow(DatabaseError);
        });
    });
    ...
    describe('createUserProfile', () => {
        ...
        it('should create user profile successfully', async () => {
            ...
            const result = await createUserProfile(mockUserId, mockEmail, createRequest);
        ...
        it('should throw ValidationError when username is empty', async () => {
            ...
            await expect(createUserProfile(mockUserId, mockEmail, invalidRequest))
        ...
        it('should throw ValidationError when username is not unique', async () => {
            ...
            await expect(createUserProfile(mockUserId, mockEmail, createRequest))
    ...
    describe('updateUserProfile', () => {
        ...
        it('should throw ValidationError when profile not found', async () => {
            ...
            await expect(updateUserProfile(mockUserId, updateRequest))
    ...
    describe('completeOnboarding', () => {
        ...
        it('should throw ValidationError when user not found', async () => {
            ...
            await expect(completeOnboarding(mockUserId))
                .rejects.toThrow('User profile not found');
        });
    });
    ...
    describe('deleteUserProfile', () => {
        it('should mark profile as deleted', async () => {
            mockSend.mockResolvedValueOnce({});
